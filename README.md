...
The binary installation files are found in the [dist](/dist) directory. Choose the one that matches your operating system (OSX Intel or Silicon, Windows 10 or Windows 11, & Matlab App). Download (unzip if OSX) and run. The helper app will guide you through installation.
<br />
<br />
