...
for i = 1:width(X)
    Si = calcStats(X(:,i),isQC,isSample,isBlank,isReference,Logged=baseConfig.LogTransformedCorrection,BlankRatioMethod=baseConfig.BlankRatioMethod,RelativeLOQ=baseConfig.RelativeLOQ);
    S(i) = Si;
